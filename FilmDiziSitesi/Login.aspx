<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Login.aspx.cs" Inherits="FilmDiziSitesi.Login" %>
...
<html lang="en">
   <head>
      ...
      <!-- Meta tags -->
      <!--stylesheets-->
       <link href="DiziBlogTema/web/css/bootstrap.css" rel="stylesheet" />
   ...
   <body>
         ...
         <div class="art-right-w3ls">
            ...
            <form action="#" method="post" runat="server">
               <div class="main">
                  ...
                  <div class="form-left-to-w3l ">
                     <asp:TextBox ID="TextBox2" runat="server" placeholder="Şifreniz" required="" TextMode="Password"></asp:TextBox>
                     <div class="clear"></div>
                  </div>
               </div>
      ...
      <footer class="bottem-wthree-footer">
         <p>
            © 2021 Tüm Hakları Saklıdır !!! | Design by
            <a href="http://linkedin.com/in/ömer-yılmaz-416347259/" target="_blank">ÖMER YILMAZ</a>
         </p>
      </footer>
   </body>
</html>
